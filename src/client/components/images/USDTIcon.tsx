...
export const USDTIcon: FC<SVGProps<SVGSVGElement>> = ({ width, height }) => {
    return (
        <svg width={width} height={height} fill="none" viewBox="0 0 339.43 295.27" xmlns="http://www.w3.org/2000/svg">
            <path
