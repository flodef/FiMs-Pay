...
export const TOPUP_COST = 1000000 + 115000; //Top up cost in lamports (max transaction fees + account rent)
export const WITHDRAW_COST = 145000; //Withdraw cost in lamports (max transaction fees)
