...
export const ABOUT_LINK = process.env.NEXT_PUBLIC_ABOUT_LINK || 'https://fims.fi/pay';
export const HELP_LINK = process.env.NEXT_PUBLIC_HELP_LINK || 'https://fims.fi/faq';
